...
class ProductPage(BasePage):
    ...
    def should_see_benefit_applying_msg(self):
        assert self.is_element_present(
            *ProductPageLocators.ALERT_OFFER_APPLIED), "There is no message about offer applying"
    ...
    def should_not_be_success_msg(self):
        assert self.is_not_element_present(
            *ProductPageLocators.ALERT_NAME), "Success message is present, but should not be"

    def should_be_dissapeared_msg(self):
        assert self.is_disappeared(*ProductPageLocators.ALERT_NAME), "Success message doesn't disappear, but should"
